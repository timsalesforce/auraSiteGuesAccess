...
import { OMNIDEF } from './lWCGuestEnglish_def.js';
import tmpl from './lWCGuestEnglish.html';
import tmpl_nds from './lWCGuestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lWCGuestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
